  ...
  const handleRegister = async () => {
    ...
    try {
      const rentalRecord = {
        carName,
        clientName,
        rentalValue: Number(rentalValue.replace(',', '.')) || rentalValue,
        rentalDate,
        createdAt: new Date().toISOString()
      };

      await addDoc(collection(db, 'alugueis'), rentalRecord);
      ...
      setIsSuccess(false);
      setModalMessage('Falha ao registrar aluguel: ' + error.message);
      setModalVisible(true);
    }
  };
